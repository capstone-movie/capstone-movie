...
export function Navbar({clearSessionAction}: NavbarProps) {
    ...
    return (
        <>
            <nav
                className="w-full bg-fhcolor/90 backdrop-blur-xs overflow-x-hidden text-white flex justify-between items-end p-4 sticky top-0 z-20 border-b-[1px] border-[#9994]">
                {/* Hamburger Menu */}
